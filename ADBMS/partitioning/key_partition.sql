CREATE TABLE account_info_key_partition (
    ID INT,
    Name VARCHAR(50),
    Age INT,
    Email VARCHAR(100),
...
INSERT INTO account_info_key_partition (ID, Name, Age, Email) VALUES
...
ALTER TABLE account_info_key_partition PARTITION BY KEY () PARTITIONS 4;
SELECT * FROM account_info_key_partition PARTITION(p1);